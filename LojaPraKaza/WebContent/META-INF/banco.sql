...
--
-- Host: 127.0.0.1    Database: prakaza_db
-- ------------------------------------------------------
...
CREATE TABLE `mercadoria` (
  `idmercadoria` bigint(10) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `mercadoria` VALUES (1,'adidas','vestuario',5,'vestido preto',45),(2,'adidas','vestuario',50,'vestido preto',45);
...
-- Dump completed on 2015-10-07 22:27:09
